 During Assignment 002, in the MainActivity.java, I change the DownloadUpdate class to update my location, then create the TemUpdate class to update the temperature.
